...
namespace Grit.Configuration
{
    public static class RabbitMQ
    {
        ...
        public static readonly string ACEQueueConnectionString = "host=192.168.3.51;virtualHost=grit;username=event_user;password=event_password;timeout=10;prefetchcount=50";
    }
}
